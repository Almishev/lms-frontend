    ...
    <StyledFooter>
      <Center>
        <FooterContent>
          <FooterSection>
            <Logo>
              <h2>Библиотека с. Мосомище</h2>
              <p>
                Библиотека с. Мосомище е местна библиотека, която предлага широк асортимент от книги за всички възрасти.
              </p>
              <SocialLinks>
          ...
          <FooterSection>
            <h3>Жанрове</h3>
            <ul>
              <li><Link href="/products">Всички книги</Link></li>
        ...
        <BottomBar>
          <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '20px'}}>
            <div>
              © {new Date().getFullYear()} Библиотека с. Мосомище. Всички права запазени.
            </div>
          </div>
        </BottomBar>
      </Center>
